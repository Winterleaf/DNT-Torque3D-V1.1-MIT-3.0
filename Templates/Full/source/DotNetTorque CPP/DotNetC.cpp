...
extern "C" __declspec(dllexport) S32  __cdecl wle_fn__getAppVersionNumber()
{
{
{
...
extern "C" __declspec(dllexport) void  __cdecl wle_fn__getAppVersionString(char* retval)
{
dSprintf(retval,4096,"");
const char* wle_returnObject;
{
...
extern "C" __declspec(dllexport) S32  __cdecl wle_fnScriptTickObject_isProcessingTicks(char * x__object)
{
ScriptTickObject* object; Sim::findObject(x__object, object ); 
if (!object)
	 return 0;
bool wle_returnObject;
{
   {wle_returnObject =object->isProcessingTicks();
return (S32)(wle_returnObject);}
}
}
extern "C" __declspec(dllexport) void  __cdecl wle_fnScriptTickObject_setProcessTicks(char * x__object, bool tick)
{
ScriptTickObject* object; Sim::findObject(x__object, object ); 
if (!object)
	 return;
