...
private ColorF _damageFrameColor = null;
/// <summary>
...
void _damageFrameColor_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
       dnTorque.self.SetVar(_mSimObjectId + ".damageFrameColor", e.NewValue);
       }
private Point2I _damageOffset = null;
/// <summary>
...
void _damageOffset_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
       dnTorque.self.SetVar(_mSimObjectId + ".damageOffset", e.NewValue);
       }
private Point2I _damageRect = null;
/// <summary>
...
void _damageRect_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
