...
private Point2F _texDirection = null;
/// <summary>
...
void _texDirection_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
       dnTorque.self.SetVar(_mSimObjectId + ".texDirection", e.NewValue);
       }
private Point2F _texOffset = null;
/// <summary>
...
void _texOffset_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
