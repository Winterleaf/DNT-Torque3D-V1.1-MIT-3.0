...
/// </summary>
public GuiTSCtrl__RenderStyles renderStyle
       {
       get
          {          return (GuiTSCtrl__RenderStyles)Enum.Parse(typeof(GuiTSCtrl__RenderStyles), dnTorque.self.GetVar(_mSimObjectId + ".renderStyle"));
          }
       set
          {
          dnTorque.self.SetVar(_mSimObjectId + ".renderStyle", value.ToString());
          }
       }
/// <summary>
