...
private EaseF _ambientLightBlendCurve = null;
/// <summary>
...
void _ambientLightBlendCurve_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
...
private ColorI _canvasClearColor = null;
/// <summary>
...
void _canvasClearColor_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
...
void _fogColor_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
...
public TypeSFXDistanceModel soundDistanceModel
       {
       get
          {          return (TypeSFXDistanceModel)Enum.Parse(typeof(TypeSFXDistanceModel), dnTorque.self.GetVar(_mSimObjectId + ".soundDistanceModel").Replace(" ", "zz_zz"));
          }
       set
          {
          dnTorque.self.SetVar(_mSimObjectId + ".soundDistanceModel", value.ToString().Replace("zz_zz"," "));
          }
       }
/// <summary>
