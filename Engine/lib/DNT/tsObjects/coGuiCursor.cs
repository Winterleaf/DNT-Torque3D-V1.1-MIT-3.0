...
public String bitmapName
       ...
       get
          {
          return dnTorque.self.GetVar(_mSimObjectId + ".bitmapName").AsString();
          }
       set
          {
          dnTorque.self.SetVar(_mSimObjectId + ".bitmapName", value.AsString());
          }
       }
private Point2I _hotSpot = null;
/// <summary>
...
public Point2I hotSpot
       ...
       set
          {
          dnTorque.self.SetVar(_mSimObjectId + ".hotSpot", value.AsString());
          }
       }
void _hotSpot_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
       dnTorque.self.SetVar(_mSimObjectId + ".hotSpot", e.NewValue);
       }
private Point2F _renderOffset = null;
/// <summary>
...
public Point2F renderOffset
       ...
       set
          {
          dnTorque.self.SetVar(_mSimObjectId + ".renderOffset", value.AsString());
          }
       }
void _renderOffset_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
