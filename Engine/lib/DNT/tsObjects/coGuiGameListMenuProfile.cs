...
private Point2I _hitAreaLowerRight = null;
/// <summary>
...
void _hitAreaLowerRight_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
       dnTorque.self.SetVar(_mSimObjectId + ".hitAreaLowerRight", e.NewValue);
       }
private Point2I _hitAreaUpperLeft = null;
/// <summary>
...
void _hitAreaUpperLeft_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
       dnTorque.self.SetVar(_mSimObjectId + ".hitAreaUpperLeft", e.NewValue);
       }
private Point2I _iconOffset = null;
/// <summary>
...
void _iconOffset_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
       dnTorque.self.SetVar(_mSimObjectId + ".iconOffset", e.NewValue);
       }
private Point2I _rowSize = null;
/// <summary>
...
void _rowSize_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
