...
private ColorI _handleColor = null;
/// <summary>
...
void _handleColor_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
       dnTorque.self.SetVar(_mSimObjectId + ".handleColor", e.NewValue);
       }
private RectF _handleRect = null;
/// <summary>
...
void _handleRect_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
