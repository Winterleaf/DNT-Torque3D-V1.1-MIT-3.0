...
public int controlPoints
       ...
       get
          {
          return dnTorque.self.GetVar(_mSimObjectId + ".controlPoints").AsInt();
          }
       set
          {
          dnTorque.self.SetVar(_mSimObjectId + ".controlPoints", value.AsString());
          }
       }
private VectorFloat  _filter = null;
/// <summary>
...
public VectorFloat  filter
       ...
       set
          {
          dnTorque.self.SetVar(_mSimObjectId + ".filter", value.AsString());
          }
       }
void _filter_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
       dnTorque.self.SetVar(_mSimObjectId + ".filter", e.NewValue);
       }
private Point2F _identity = null;
/// <summary>
/// @internal
/// </summary>
public Point2F identity
       ...
       set
          {
          dnTorque.self.SetVar(_mSimObjectId + ".identity", value.AsString());
          }
       }
void _identity_OnChangeNotification(object o, Notifier.ChangeNotificationEventArgs e)
       {
...
public bool showIdentity
       ...
       get
          {
          return dnTorque.self.GetVar(_mSimObjectId + ".showIdentity").AsBool();
          }
       set
          {
          dnTorque.self.SetVar(_mSimObjectId + ".showIdentity", value.AsString());
          }
       }
/// <summary>
